...
If using Visual Studio Code you can launch code and activate the workspace (wikiSpyder.code-workspace) and code will setup and/or install the dependicies as well as suggest useful addons.
